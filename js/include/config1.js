			...
			$('#wizard_name').bootstrapWizard({
				...
				onNext : function(tab, navigation, index) {
					...
					if(index==1){
						...
						if (!$('#persona').val()) {
				 		$.jGrowl('Por favor digite el nombre de la persona');
						$('#persona').focus();
						...
						{
							$('#persona').closest('.control-group').addClass('success');
						}
 						// Make sure we entered the name
 						if (!$('#idPersona').val()) {
				 		$.jGrowl('Por favor digite la identificación');
						$('#idPersona').focus();
							$('#idPersona').closest('.control-group').removeClass('success');
							$('#idPersona').closest('.control-group').addClass('error');
							return false;
						}					

						if (!$('#ciudadP').val()) {
				 		$.jGrowl('Por seleccione la ciudad de expedida de la identificación');
						$('#ciudadP').focus();
							$('#ciudadP').closest('.control-group').removeClass('success');
							$('#ciudadP').closest('.control-group').addClass('error');
							return false;
						} 

						if (!$('#fchPago').val()) {
				 		$.jGrowl('Por favor digite la fecha de pago');
						$('#fchPago').focus();
							$('#fchPago').closest('.control-group').removeClass('success');
							$('#fchPago').closest('.control-group').addClass('error');
							return false;
						} 

						if (!$('#cuenta').val()) {
				 		$.jGrowl('Por favor digite el número de cuenta');
						$('#cuenta').focus();
							$('#cuenta').closest('.control-group').removeClass('success');
							$('#cuenta').closest('.control-group').addClass('error');
							return false;
						} 

						if (!$('#tipoCuenta').val()) {
				 		$.jGrowl('Por favor seleccione un tipo cuenta');
						$('#tipoCuenta').focus();
							$('#tipoCuenta').closest('.control-group').removeClass('success');
							$('#tipoCuenta').closest('.control-group').addClass('error');
							return false;
						} 
 						
 						if (!$('#banco').val()) {
				 		$.jGrowl('Por favor seleccione un banco');
						$('#banco').focus();
							$('#banco').closest('.control-group').removeClass('success');
							$('#banco').closest('.control-group').addClass('error');
							return false;
						} 
