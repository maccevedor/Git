		...
		if ($('#wizard_name').length) {
			$('#wizard_name').bootstrapWizard({
				...
				onNext : function(tab, navigation, index) {
					...
					//Aqui Empiezo a recorre los step se anaden las validaciones necesarias	
					...
					if(index==1){
						...
						if(document.getElementById('termino').checked == true)
						{}else
						{ // code here 

							$.jGrowl('Recuerde aceptar cláusula de tratamiento de datos personales');
							$('#termino').focus();
							$('#termino').closest('.control-group').removeClass('success');
							$('#termino').closest('.control-group').addClass('error');
							return false;
						}

				 		
 						if (!$('#formacion').val()) {
				 		$.jGrowl('Por favor seleccione un nivel de formación');
						$('#formacion').focus();
							$('#formacion').closest('.control-group').removeClass('success');
							$('#formacion').closest('.control-group').addClass('error');
							return false;
						} else
						{
							$('#formacion').closest('.control-group').addClass('success');

						}


						if (!$('#programa').val()) {
				 		$.jGrowl('Por favor seleccione un programa');
						$('#programa').focus();
							$('#programa').closest('.control-group').removeClass('success');
							$('#programa').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#programa').closest('.control-group').addClass('success');
						} 		

						if (!$('#tipoId').val()) {
				 		$.jGrowl('Por favor seleccione su tipo de identificación');
						$('#tipoId').focus();
							$('#tipoId').closest('.control-group').removeClass('success');
							$('#tipoId').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#tipoId').closest('.control-group').addClass('success');
						} 								
	


						if (!$('#identificacion').val()) {
				 		$.jGrowl('Por favor digite su identificación');
						$('#identificacion').focus();
							$('#identificacion').closest('.control-group').removeClass('success');
							$('#identificacion').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#identificacion').closest('.control-group').addClass('success');
						} 								

 						if (!$('#nombre').val()) {
				 		$.jGrowl('Por favor digite su nombre');
						$('#nombre').focus();
							$('#nombre').closest('.control-group').removeClass('success');
							$('#nombre').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#nombre').closest('.control-group').addClass('success');
						}

					

						if (!$('#apellido').val()) {
				 		$.jGrowl('Por favor digite su apellido');
						$('#apellido').focus();
							$('#apellido').closest('.control-group').removeClass('success');
							$('#apellido').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#apellido').closest('.control-group').addClass('success');
						}
						...
						if (!$('#lNacimiento').val()) {
				 		$.jGrowl('Por favor seleccione su lugar de nacimineto');
						$('#lNacimiento').focus();
							$('#lNacimiento').closest('.control-group').removeClass('success');
							$('#lNacimiento').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#lNacimiento').closest('.control-group').addClass('success');
						}

						if (!$('#direccion').val()) {
				 		$.jGrowl('Por favor digite su dirección');
						$('#direccion').focus();
							$('#direccion').closest('.control-group').removeClass('success');
							$('#direccion').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#direccion').closest('.control-group').addClass('success');
						}

						if (!$('#ciudad').val()) {
				 		$.jGrowl('Por favor seleccione la ciudad');
						$('#ciudad').focus();
							$('#ciudad').closest('.control-group').removeClass('success');
							$('#ciudad').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#ciudad').closest('.control-group').addClass('success');
						}

						if (!$('#barrio').val()) {
				 		$.jGrowl('Por favor seleccione la barrio');
						$('#barrio').focus();
							$('#barrio').closest('.control-group').removeClass('success');
							$('#barrio').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#barrio').closest('.control-group').addClass('success');
						}



						if (!$('#telefono').val()) {
				 		$.jGrowl('Por favor digite su teléfono');
						$('#telefono').focus();
							$('#telefono').closest('.control-group').removeClass('success');
							$('#telefono').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#telefono').closest('.control-group').addClass('success');
						}

						if (!$('#email').val()) {
                        $.jGrowl('Por digite su correo');
                        $('#email').focus();
                        ...
                        return false;
		                        ...
		                        if (!(wizard.email.value.match(emailExp)))
		                        {
		                            $.jGrowl("Favor Ingrese un email válido");
		                            wizard.email.focus();
		                            return false;
		                        }
		                        else {
		                            $('#email').addClass('valid').closest('.control-group').addClass('success');
		                        }

		                    }
					

		                    if(document.all['nivel[]'].value=="")
							 {
							 $.jGrowl('Por favor seleccione un nivel de estudios');
							 document.all['nivel[]'].focus();
							 return false;
							 }

		                	if(document.all['titulo[]'].value=="")
							 {
							 $.jGrowl('Por favor digite un título academico');
							 document.all['titulo[]'].focus();
							 return false;
							 }


		                	if(document.all['institucion[]'].value=="")
							 {
							 $.jGrowl('Por favor digite un institución');
							 document.all['institucion[]'].focus();
							 return false;
							 }
    
							 $.jGrowl('Paso 2 , por favor diligenciar la entrevista');
					...
					if (!$('#programaAcademico').val()) {
				 		$.jGrowl('Por favor digite cuáles fueron los motivos que lo llevaron a escoger el programa académico seleccionado');
						$('#programaAcademico').focus();
							$('#programaAcademico').closest('.control-group').removeClass('success');
							$('#programaAcademico').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#programaAcademico').closest('.control-group').addClass('success');
						} 

					if (!$('#experiencia').val()) {
				 		$.jGrowl('Por favor  digite que experiencia profesional tiene en el área correspondiente en al programa académico seleccionado');
						$('#experiencia').focus();
							$('#experiencia').closest('.control-group').removeClass('success');
							$('#experiencia').closest('.control-group').addClass('error');
							return false;
						} else{
							$('#programaAcademico').closest('.control-group').addClass('success');
						} 
					...
					if (!$('#umb').val()) {
				 		$.jGrowl('Por favor digite que conoce de la universidad Manuela Beltran');
						$('#umb').focus();
							$('#umb').closest('.control-group').removeClass('success');
							$('#umb').closest('.control-group').addClass('error');
							return false;
						}else{
							$('#umb').closest('.control-group').addClass('success');
						} 


					if ($('input[name="financiacion"]:checked').length)
							{
									$('#financiacion').closest('.control-group').addClass('success');
							}
							else
							{
							 $.jGrowl('Por favor seleccione una de las opciones de fuente de financiación para estudiar');
							$('#financiacion').focus();
							$('#financiacion').closest('.control-group').removeClass('success');
							$('#financiacion').closest('.control-group').addClass('error');
							 return false;
							}

							if ($('input[name="computadora"]:checked').length)
							{
									$('#computadora').closest('.control-group').addClass('success');
							}
							else
							{
							 $.jGrowl('Por favor seleccione su nivel de conocimiento sobre el manejo de computadores');
							$('#computadora').focus();
							$('#computadora').closest('.control-group').removeClass('success');
							$('#computadora').closest('.control-group').addClass('error');
							 return false;
							}

							if ($('input[name="TIC"]:checked').length)
							{
									$('#TIC').closest('.control-group').addClass('success');
							}
							else
							{
							$.jGrowl('Por favor seleccione  su nivel de conocimiento en Tecnología, Información y la Comunicación (TICs)');
							$('#TIC').focus();
							$('#TIC').closest('.control-group').removeClass('success');
							$('#TIC').closest('.control-group').addClass('error');
							 return false;
							}
							...
							if (!$('#institucionT').val()) {
						 		$.jGrowl('Por favor digite donde trabaja');
								$('#institucionT').focus();
									$('#institucionT').closest('.control-group').removeClass('success');
									$('#institucionT').closest('.control-group').addClass('error');
									return false;
								}else{
									$('#institucionT').closest('.control-group').addClass('success');
								} 

								if (!$('#direccionT').val()) {
						 		$.jGrowl('Por favor digite la direccion donde trabaja');
								$('#direccionT').focus();
									$('#direccionT').closest('.control-group').removeClass('success');
									$('#direccionT').closest('.control-group').addClass('error');
									return false;
								}else{
									$('#direccionT').closest('.control-group').addClass('success');
								} 
								...
								if (!$('#telefonoT').val()) {
						 		$.jGrowl('Por favor digite la teléfono donde trabaja');
								$('#telefonoT').focus();
									$('#telefonoT').closest('.control-group').removeClass('success');
									$('#telefonoT').closest('.control-group').addClass('error');
									return false;
								}else{
									$('#telefonoT').closest('.control-group').addClass('success');
								}	


								if (!$('#fchInicio').val()) {
							 		$.jGrowl('Por favor digite la fecha cuando inicio a trabajar');
									$('#fchInicio').focus();
										$('#fchInicio').closest('.control-group').removeClass('success');
										$('#fchInicio').closest('.control-group').addClass('error');
										return false;
									}else{
										$('#fchInicio').closest('.control-group').addClass('success');
									}
								if (!$('#ciudadT').val()) {
							 		$.jGrowl('Por favor seleccione la ciudad');
									$('#ciudadT').focus();
										$('#ciudadT').closest('.control-group').removeClass('success');
										$('#ciudadT').closest('.control-group').addClass('error');
										return false;
									}else{
										$('#ciudadT').closest('.control-group').addClass('success');
									}	
				 ...
				 // 		$.jGrowl('Por favor digite que conoce de la universidad Manuela Beltran');
					// 	$('#persona').focus();
					// 		$('#persona').closest('.control-group').removeClass('success');
					// 		$('#persona').closest('.control-group').addClass('error');
					// 		return false;
					// 	} 	
				...
				//},
				 onTabClick : function(tab, navigation) {
					//console.log('onTabClick');
					$.jGrowl('Esta pestaña esta deshabilitada utilice los botones de navegación que se encuentran el la parte inferior');
					return false;
				},
